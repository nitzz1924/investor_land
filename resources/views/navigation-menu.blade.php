    ...
    <div class="with-vertical">
        ...
        <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-block d-lg-none py-2">
                <a href="https://investorlands.com/admin/dashboard" class="text-nowrap logo-img">
                    <img src="https://investorlands.com/assets/images/logo.png" class="dark-logo" alt="Logo-Dark" width="75px" />
                    <img src="https://investorlands.com/assets/images/logo.png" class="light-logo" alt="Logo-light"  width="75px" />
                </a>
            </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <h5 class="mb-1 me-3 fs-3">My Profile</h5>
                                    </div>

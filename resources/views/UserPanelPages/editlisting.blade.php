                ...
                <div class="card">
                     <form>
                            <div class="card-body">
                                ...
                                <img id="map-image" 
                                src="https://maps.googleapis.com/maps/api/staticmap?key=AIzaSyA_KLtDmYZB0Qy_b0f6LHJSlDV2wYYPf8s&center={{ $locations['Latitude'] }},{{ $locations['Longitude']}}&zoom=14&size=480x400&maptype=roadmap&sensor=false" 

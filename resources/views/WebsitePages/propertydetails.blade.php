...
@section('content')
    <div class="page-header parallaxie" style="background: url({{ asset('assets/images/Listings/'. $propertydetails->thumbnail) }}) no-repeat center center;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="property-single-content">
                        ...
                        <div class="about-property wow " data-wow-delay="0.75s">
                            ...
                            <div class="about-property-content">
                                <p class="fs-3 fw-bold text-black">₹{{ $propertydetails->price }} /-</p>
                            ...
                            <div class="property-amenities wow" data-wow-delay="1s">
                                ...
                                <div class="property-amenities-box">
                                    ...
                                    @if (in_array(strtolower($fileExtension), ['jpg', 'jpeg']))
                                        <img src="{{ asset('assets/images/Listings/' . $propertydetails->masterplandoc) }}"
                                            alt="Master Plan" style="max-width: 100%; height: auto;">
                                        <div class="d-flex justify-content-center mt-3">
                                            <a href="{{ asset('assets/images/Listings/' . $propertydetails->masterplandoc) }}"
                                                download class="btn-default">Download</a>
                                        </div>
                                    @elseif(strtolower($fileExtension) == 'pdf')
                                        <iframe
                                            src="{{ asset('assets/images/Listings/' . $propertydetails->masterplandoc) }}"
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="totalPrice" value="146784424" min="0"
                                                    oninput="validateInput(this, false)" />
                                                <input type="range" id="totalPriceRange" min="10000000"
                                                    max="500000000" value="146784424" step="100000" />
                                            </div>
                                            <div class="input-group">
                                                <label for="loanPeriod">Loan Period (Years):</label>
                                                <input type="number" id="loanPeriod" value="25" min="0"
                                                    oninput="validateInput(this , true)" />
                                                <input type="range" id="loanPeriodRange" min="1" max="30"
                                                    value="25" step="1" />
                                            </div>
                                            <div class="input-group">
                                                <label for="downPayment">Down Payment (INR):</label>
                                                <input type="number" id="downPayment" value="29356885" min="0"
                                                    oninput="validateInput(this , false)" />
                                                <input type="range" id="downPaymentRange" min="0"
                                                    max="146784424" value="29356885" step="100000" />
                                            </div>
                                            <div class="input-group">
                                                <label for="interestRate">Interest Rate (%):</label>
                                                <input type="number" id="interestRate" value="4.74" min="0"
                                                    oninput="validateInput(this , true)" />
                                                <input type="range" id="interestRateRange" min="1"
                                                    max="20" value="4.74" step="0.01" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="result">
                        ...
                        <div class="property-map-location wow" data-wow-delay="1.25s">
                            ...
                            <div class="property-map-iframe">
                                <img id="map-image" class="rounded-3"
                                    ...
                                    width="800" height="400" alt="Google Maps Location" />
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach ($listings->take(4) as $latest)
                                    <div class="recent-post-item">
                                        <div class="post-image">
                                            <a target="_blank"
                                                href="{{ route('website.propertydetails', ['id' => $latest->id]) }}">
                                                <img src="{{ asset('assets/images/Listings/' . $latest->thumbnail) }}"
                                                    alt="">
                                            </a>
                                        </div>

                                        <div class="post-info">
                                            <p class="meta"><a target="_blank"
                                                    href="{{ route('website.propertydetails', ['id' => $latest->id]) }}">{{ $latest->category }}</a>
                                            </p>
                                            <h4><a
                                                    href="{{ route('website.propertydetails', ['id' => $latest->id]) }}">{{ Str::limit($latest->property_name, 15) }}</a>
                                            </h4>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 mb-3">
                                            <input type="text"
                                                ...
                                                name="customername" class="form-control" id="customername"
                                        ...
                                        <div class="form-group col-md-12 mb-3">
                                            <input type="text"
                                                value="{{ Auth::guard('customer')->check() ? Auth::guard('customer')->user()->mobile : '' }}"
                                        ...
                                        <div class="form-group col-md-12 mb-3">
                                            <input type="text" name="cityofproperty" class="form-control"
                                                id="city" placeholder="Property City">
                                        </div>

                                        <div class="form-group col-md-12 mb-3">
                                            <select name="propertytype" class="form-control"
                                                data-placeholder="Choose Property Type" tabindex="1">
                                                <option value="">--Choose Property Type--</option>
                                                @foreach ($categories as $row)
                                                    <option value="{{ ucfirst(strtolower($row->label)) }}">
                                                        {{ ucfirst(strtolower($row->label)) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var chart_line_basic = new ApexCharts(
                document.querySelector("#pricehistorychart"), options_line
            );
    ...
    <script>
        function validateInput(input, allowDecimal = false) {
            let value = input.value.replace(/-/g, ''); // Remove all '-' signs

    ...
    <div class="swiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a class="categorycard" data-categoryname="{{ $cat->label }}">
                    <div class="how-it-work-itemaboutnew wow fadeInUp mt-4" data-wow-delay="0.25s">
                        <div class="icon-box">
                            <img src="{{ asset('assets/images/Categories/' . $cat->categoryimage) }}" alt="">
                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="property-item">
                                        ...
                                        <div class="property-footer">
                                            <span class="badge {{ $list->featuredstatus == 'featured' ? 'text-bg-warning' : '' }}">
                                                {{ ucfirst($list->featuredstatus) }}
                                            </span>
                                        ...
                                        <div class="swiper-slide">
                                            <a href="{{ route('website.projectdetails', ['id' => $pro->id]) }}">
                                                <div class="gallery-item wow fadeInUp" data-wow-delay="0.25s">
                                                    <figure class="image-anime">
                                                        <img src="{{ asset('assets/images/Projects/' . $pro->projectthumbnail) }}" alt="">
                                                    </figure>
...
<div class="property-by-city">
    <div class="container">
        ...
        <div class="row">
            <div class="property-type-sliderbycity">
                <div class="swiper">
                    <div class="swiper-wrapper">
                        @foreach ($listingsbycitys as $row)
                        <div class="swiper-slide">
                          <a class="citycard" data-cityname="{{ $row->label }}">
...
<script>
    $(document).ready(function() {
        $('.categorycard').on('click', function() {
            ...
            console.log("%c" + category, "background: black; color: yellow; font-size: 14px; padding:10px;");
            window.location.href = "{{ route('website.propertylistings') }}?filtercategory=" + encodeURIComponent(category);
        });
    });
</script>
...
<script>
    $(document).ready(function() {
        $('.citycard').on('click', function() {
            ...
            console.log("%c" + cityname, "background: black; color: yellow; font-size: 14px; padding:10px;");
            window.location.href = "{{ route('website.propertylistings') }}?filtercity=" + encodeURIComponent(cityname);
        });
    });
</script>
@endsection

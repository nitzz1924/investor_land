                ...
                <div class="hero-search-form wow fadeInUp" data-wow-delay="1s">
                    ...
                    <form id="searchform">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4 col-6">
                                <button type="button" id="priceFilterBtn" class="form-control text-start">Price
                                    (INR)</button>
                                <div id="priceFilterDropdown" class="price-filter-dropdown d-none">
                                    ...
                                    <div class="d-flex">
                                        <input type="number" name="filterminprice" id="minPrice" class="form-control me-2"
                                            placeholder="0">
                                        <input type="text" name="filtermaxprice" id="maxPrice" class="form-control"
                                            placeholder="Any">
                                    </div>
                                    <div class="d-flex justify-content-between mt-2">
                                        <button type="button" id="resetPriceFilter" class="btn btn-light">Reset</button>
                                        <button type="button" id="applyPriceFilter" class="btn text-white"
                                            style="background-color: #726555;">Done</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-12">
                                ...
                                <div id="sqftbtnDropdown" class="price-filter-dropdownsqft d-none">
                                    ...
                                    <div class="d-flex">
                                        <input type="text" name="sqftfrom" id="sqftfrom" class="form-control me-2"
                                            placeholder="0">
                                        <input type="text" name="sqftto" id="sqftto" class="form-control"
                                            placeholder="0">
                                    </div>
                                    <div class="d-flex justify-content-between mt-2">
                                        <button type="button" id="resetsqftfilter" class="btn btn-light">Reset</button>
                                        <button type="button" id="applysqftfilter" class="btn text-white"
                                            style="background-color: #726555;">Done</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($categories as $cat)
                                <div class="swiper-slide">
                                    <div class="how-it-work-itemaboutnew wow fadeInUp mt-4" data-wow-delay="0.25s">
                                        <div class="icon-box">
                                            <img src="{{ asset('assets/images/Categories/' . $cat->categoryimage) }}"
                                                alt="">
                                        </div>
                                        <h3>{{ $cat->label }}</h3>
                                    </div>
                                            ...
                                            <div class="property-header">
                                                <a href="{{ route('website.propertydetails', ['id' => $list->id]) }}">
                                                    <figure class="image-anime">
                                                        <img src="{{ asset('assets/images/Listings/' . $list->thumbnail) }}"
                                                            alt="">
                                                    </figure>
                                                </a>
                                            ...
                                            <div class="property-body">
                                                ...
                                                <div class="property-meta">
                                                    <div class="property-amenity-item">
                                                        <div class="icon-box">
                                                            <img src="{{ asset('websiteAssets/images/icon-badroom.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>{{ $list->bedroom }} <span
                                                                class="hideshowproperty">Bedsroom</span>
                                                    </div>

                                                    <div class="property-amenity-item">
                                                        <div class="icon-box">
                                                            <img src="{{ asset('websiteAssets/images/icon-bathroom.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>{{ $list->bathroom }} <span
                                                                class="hideshowproperty">Bathrooms</span>
                                                    </div>

                                                    <div class="property-amenity-item">
                                                        <div class="icon-box">
                                                            <img src="{{ asset('websiteAssets/images/icon-area.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>{{ $list->squarefoot }} <span class="hideshowproperty">sq
                                                                ft</span>
                                                    </div>

                                                    <div class="property-amenity-item">
                                                        <div class="icon-box">
                                                            <img src="{{ asset('websiteAssets/images/icon-garage.svg') }}"
                                                                alt="">
                                                        </div>
                                                        <span>{{ $list->floor }} <span
                                                                class="hideshowproperty">Floors</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="property-footer">
                                                <span
                                                    class="badge {{ $list->status == 'published' ? 'text-bg-success' : 'text-bg-danger' }}">
                                                    {{ ucfirst($list->status) }}
                                                </span>
                                                <a href="{{ route('website.propertydetails', ['id' => $list->id]) }}"
                                                    class="btn-default">View Property
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper">
                                        <div class="swiper-wrapper">
                                            @foreach ($projects as $pro)
                                                <div class="swiper-slide">
                                                    <a href="{{ route('website.projectdetails', ['id' => $pro->id]) }}">
                                                        <div class="gallery-item wow fadeInUp" data-wow-delay="0.25s">
                                                            <figure class="image-anime">
                                                                <img src="{{ asset('assets/images/Projects/' . $pro->projectthumbnail) }}"
                                                                    alt="">
                                                            </figure>
                                                            <p class="text-black mt-3">{{ $pro->projectname }}</p>
                                                        </div>
                                                    </a>
                                                </div>
                                            @endforeach
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="post-item wow fadeInUp" data-wow-delay="0.25s">
                            <div class="post-featured-image">
                                <figure>
                                    <a href="#"><img src="{{ asset('assets/images/Blogs/' . $blog->blogthumbnail) }}"
                                            alt="Blog Image"></a>
                                </figure>

                                <div class="post-read-more">
                                    <a href="{{ route('website.blogdetails', ['id' => $blog->id]) }}"
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="location-item wow fadeInUp" data-wow-delay="0.25s">
                            <div class="location-image">
                                <figure>
                                    <img src="{{ asset('assets/images/Categories/' . $row->categoryimage) }}"
                                        alt="">
                                </figure>
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <figure class="reveal image-anime">
                        <img src="{{ asset('websiteAssets/images/newservice.jpg') }}" class="img-fluid rounded-4"
                            alt="">
                    </figure>
                ...
                <div class="col-lg-6 order-lg-1">
                    <div class="why-choose-us-content">
                        ...
                        <div class="why-choose-us-body wow fadeInUp" data-wow-delay="0.25s">
                            <p>At Investor Lands, we provide comprehensive services to cater to all your investment and real
                                estate needs. From personalized investment consulting to property acquisition, development,
                                and management, we are your trusted partner in navigating the real estate landscape. </p>
                            <ul>
            ...
            <div class="row mt-5 expertisesection">
                <div class="col-lg-3 col-md-6">
                    <div class="how-it-work-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <p>Leverage our extensive expertise to make informed and profitable real estate investment
                            decisions.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="how-it-work-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <p>Partner with our dedicated team committed to delivering exceptional service and personalized
                            solutions.</p>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-7">
                                <div class="cta-content">
                                    ...
                                    <p class="wow fadeInUp">At Investor Lands, our experienced professionals are here to
                                        guide you through every step of your investment journey. Reach out today for
                                        personalized advice and insights tailored to your goals.</p>
                                </div>
                            </div>

                            <div class="col-lg-5">
                                <div class="cta-button">
                                    <a href="tel:+919461257675" class="btn-default btn-border"><i
                                            class="fa-solid fa-phone-volume"></i> +91-94612-57675</a>
    ...
    <div class="why-choose-us">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <figure class="reveal image-anime">
                        <img src="{{ asset('websiteAssets/images/aboutus.jpg') }}" class="img-fluid rounded-4"
                            alt="">
                    </figure>
                    <!-- Why Choose us Images End -->
                </div>
                ...
                <div class="col-lg-6 order-lg-1">
                    <div class="why-choose-us-content">
                        ...
                        <div class="why-choose-us-body wow fadeInUp" data-wow-delay="0.25s">
                            <p>At Investor Lands, we are passionate about transforming investment opportunities into lasting
                                value. With a strong foundation in real estate expertise, we specialize in offering premium
                                projects that align with our clients' financial goals. Our mission is to simplify the
                                complexities of real estate investment through transparency, integrity, and innovation.</p>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-slide">
                                        <div class="testimonial-rating">
                                            <img src="{{ asset('websiteAssets/images/icon-rating.svg') }}"
                                                alt="">
                                        </div>

                                        <div class="testimonial-content">
                                            <p>Investor Lands made the process of finding the perfect investment seamless.
                                                Their team was incredibly professional and guided me every step of the way.
                                                I highly recommend their services to anyone looking for reliable real estate
                                                solutions!</p>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-content">
                                            <p>I was impressed with the transparency and dedication of the team at Investor
                                                Lands. They ensured I was informed about every detail, making me feel
                                                confident in my decision. A truly stress-free experience!</p>
                                        </div>
                                        <div class="testimonial-author-info">
                                            <h3>- Neha Verma</h3>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-content">
                                            <p>The expertise and range of projects at Investor Lands are unmatched. They
                                                helped me find a property that fit my budget and long-term goals perfectly.
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-slide">
                                        ...
                                        <div class="testimonial-content">
                                            <p>What stood out to me about Investor Lands was their commitment to quality and
                                                transparency. Their team went above and beyond to address all my concerns
                                                and helped me secure the best deal. Highly recommended!</p>
                                        </div>
                                        <div class="testimonial-author-info">
                                            <h3>- Priya Iyer</h3>
                                        </div>
